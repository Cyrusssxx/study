...
PDF = glob.glob(r"d:/ai code/408教材/2027王道*数据*.pdf")[0]
OS_JSON = r"pwa/data/ds.json"
BODY_START = 13  # page 0-based: first BODY '本节试题精选' is 1.1.3 (pages 0-12 are TOC)
...
q_hdr = re.compile(r'(\d+)\.(\d+)\.\d+\s*本节试题精选')
